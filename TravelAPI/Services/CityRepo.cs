...
namespace TravelAPI.Services
{
    public class CityRepo : Repository, ICityRepo
    {
        ...
        public async Task<CityModel> GetCityById(int cityId, bool includeCoutry = false)
        {
        ...
        public async Task<CityModel> GetCityByName(string name, bool includeCoutry = false)
        {
